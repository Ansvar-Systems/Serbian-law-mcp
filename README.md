...
Serbian law database for cybersecurity compliance via Model Context Protocol (MCP).
...
### Claude Code (Remote)
```bash
claude mcp add serbian-law --transport http https://serbian-law-mcp.vercel.app/mcp
```
